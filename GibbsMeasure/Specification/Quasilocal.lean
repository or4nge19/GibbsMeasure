...
noncomputable def cylinderFunctions (S E F : Type*) [TopologicalSpace E] [NormedAddCommGroup F] [NormedSpace ℝ F] :
...
noncomputable def quasilocalFunctions (S E F : Type*) [TopologicalSpace E] [NormedAddCommGroup F] [NormedSpace ℝ F] :
    Submodule ℝ ((S → E) →ᵇ F) :=
