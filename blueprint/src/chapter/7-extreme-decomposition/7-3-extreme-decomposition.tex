...
\begin{corollary}[Georgii (7.28)--(7.30)]
    ...
    (7.30): for a quasilocal $\lambda$-specification over a $\sigma$-finite non-zero a priori
    measure, $\mathcal{G}(\gamma)$ is the closed convex hull of the limiting Gibbs distributions
    in the topology of local convergence; likewise for an arbitrary quasilocal $\gamma$ over a
    finite state space.
\end{corollary}
