...
\begin{example}[Almost sure, not strict, Georgii (7.5)]
    \label{ex:ext-75}
    \uses{thm:ext-74}
    \lean{ProbabilityTheory.Kernel.TwoAbsorbingStates.ker,
      ProbabilityTheory.Kernel.TwoAbsorbingStates.mu,
      ProbabilityTheory.Kernel.TwoAbsorbingStates.invariant_mu,
      ProbabilityTheory.Kernel.TwoAbsorbingStates.eq_empty_or_univ_of_strictly_invariant,
      ProbabilityTheory.Kernel.TwoAbsorbingStates.trivial_on_strictly_invariant,
      ProbabilityTheory.Kernel.TwoAbsorbingStates.not_mem_extremePoints}
    \leanok
