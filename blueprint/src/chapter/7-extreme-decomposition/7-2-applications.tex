...
\begin{proposition}[Georgii (7.25), in the generality of Remark (7.13)]
    ...
    \uses{def:app-abstract-spec, thm:app-extreme-iff-tail-trivial, def:cond-exp-ker,
          def:lebesgue-cond-exp}
...
\begin{example}[Georgii (7.14), Kolmogorov's zero-one law]
    ...
    \uses{def:isssd, def:isssd-spec, lem:isssd-gibbs-meas-existence,
          lem:isssd-gibbs-meas-uniqueness, thm:app-extreme-iff-tail-trivial}
...
\begin{theorem}[Georgii (7.31), de Finetti's theorem in the version of Dynkin]
    ...
    \uses{thm:app-7-17, prop:app-pa-kernel, thm:app-exchangeable-invariant,
          def:app-is-exchangeable}
