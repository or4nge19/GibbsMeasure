...
All specifications will be with parameter set $S$ and state space $(E, \mathcal{E})$ in this
chapter.
...
\begin{definition}[Specification]
    ...
    A family satisfying consistency alone is a {\bf pre-specification}.
\end{definition}
...
\begin{remark}[The probability and properness conditions]
    ...
    Both conditions are part of Definition \ref{def:spec}: every specification consists of
    probability kernels and is proper. On a pre-specification, where only consistency is assumed,
    each of them is a genuine hypothesis.
\end{remark}
