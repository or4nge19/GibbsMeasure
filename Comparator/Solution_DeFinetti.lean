...
/-!
# Comparator solution: de Finetti's theorem (Georgii, Examples (7.16) and (7.31))

The solution file matching `Comparator/Challenge_DeFinetti.lean`.  It differs from the challenge
only by `import GibbsMeasure`, the auxiliary `namespace Bridge`, and the proof terms.
